        ...
        >
            <div className="text-sm leading-relaxed bg-gray-100 p-4 rounded mt-4">
                ...
                <div className="text-sm">
                    ...
                    <p className="mb-2">5. The Customer acknowledges that:</p>
                    <div className="space-y-4 ml-6">
                        ...
                        <p className="mb-2">5.3. That Cairns Boat Storage has no liability in tort or contract or otherwise (including negligence) for:</p>
                    ...
                    <p className="mb-2">6. The Customer agrees:</p>
                    <div className="space-y-4 ml-6 mb-2">
                        <p className="ml-6 mb-2">6.1. That it is responsible for parking and removing its boat, trailer, car and any other item, and will use all due care and skill in doing so;</p>
                        <p className="ml-6 mb-2">6.2. That they are responsible for any cyclone tie down, and for securing their boat, car and any other item stored in the compound; and</p>
                        <p className="ml-6 mb-2">6.3. To indemnify Cairns Boat Storage in relation to any and all claims against it for loss, damage and expense sustained by any person arising out of any act or omission by it (including any legal costs incurred in defending such claim).</p>
                    </div>
                    ...
                    <p className="mb-2">8. The Customer acknowledges and agrees that:</p>
                    <div className="space-y-4 ml-6 mb-2">
                        <p className="ml-6 mb-2">8.1. Children are not permitted within the compound unless strictly supervised by a parent;</p>
                        <p className="ml-6 mb-2">8.2. Intoxicated persons are not permitted within the facility;</p>
                        <p className="ml-6 mb-2">8.3. Disposal of oils/greases, fuel and rubbish is the responsibility of the Customer and is not to be left in the compound. All spills must be thoroughly cleaned up immediately; and must be reported to Cairns Boat Storage</p>
                        <p className="ml-6 mb-2">8.4. They are aware that the Privacy Act 2000 may prevent Cairns Boat Storage from disclosing personal information about them without the Customer’s approval and authorise Cairns Boat Storage to provide personal details to persons who it considers, in its absolute discretion, to have a claim against the Customer.</p>
                    </div>
                    <p className="mb-2">9. Cairns Boat Storage retains the right to require the Customer and any person accompanying the Customer to immediately leave the facility and remove all items for breach of these conditions.</p>

                    <p className="mb-2 font-bold">DEFAULT</p>
                    <p className="mb-2">10. The Customer:</p>
                    <div className="space-y-4 ml-6 mb-2">
                        <p className="ml-6 mb-2">10.1. Acknowledges that, in the event of the storage fee, or any other monies owing under this Agreement, not being paid in full within 30 days of the due date, Cairns Boat Storage may, without further notice, sell or dispose of any car, boat or other item in the Facility on such terms as the owners of Cairns Boat Storage shall determine; and</p>
                        <p className="ml-6 mb-2">10.2. Authorizes the sale or disposal of the items regardless of their nature or value.</p>
                    </div>
                    <p className="mb-2">11. Cairns Boat Storage reserves the right to recover from the Customer the costs of default on the part of the Customer, including any costs associated with disposal or sale of the car, boat or other item, if the sale proceeds of the item are insufficient to cover the outstanding storage fees and the costs of removal.</p>
                    <p className="mb-2">12. If, in the opinion of Cairns Boat Storage, a defaulting Customer’s car, boat or other item is not saleable, fails to sell when offered for sale, or is not of sufficient value to warrant the expense of attempting to sell, the Customer acknowledges that Cairns Boat Storage may dispose of the car, boat or other item in any manner it thinks fit, having previously given the Customer seven (7) days notice of its intention to do so by way of posting such notice to the Customer at the residential address or email addresses provided in the Schedule.</p>

                    <p className="mb-2 font-bold">TERMINATION</p>
                    <p className="mb-2">13. When any agreed initial fixed period of storage has ended, either party may terminate this Agreement by written notice.</p>
                    <p className="mb-2">14. In the event of illegal or environmentally harmful activities being undertaken by the Customer, Cairns Boat storage may terminate the Agreement upon seven (7) days notice in writing to the Customer at its email and/or residential address provided in the Schedule. If Cairns Boat Storage determines that such illegal or environmentally harmful activities, in its sole discretion, constitute an emergency it may terminate the agreement without notice to the Customer.</p>
                    <p className="mb-2">15. Upon termination the Customer must remove all items from the Lot and leave the Lot in a clean condition to the satisfaction of Cairns Boat Storage. The Customer must pay any outstanding monies and any expenses on default or other monies owed to Cairns Boat Storage up to the date of termination. Any calculation of outstanding fees will be by Cairns Boat Storage and such calculation will be final.</p>
